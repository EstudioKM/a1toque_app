...
export const AdminPanel: React.FC<AdminPanelProps> = (props) => {
  ...
  return (
    <div className="flex min-h-screen bg-black">
      ...
      {isSocialPostDetailOpen && selectedSocialPost && ( <SocialPostDetailModal post={selectedSocialPost} onClose={() => setIsSocialPostDetailOpen(false)} onDelete={props.onDeleteSocialPost} socialAccountMap={socialAccountMap} brandMap={brandMap}/>)}
